...
export default function DashboardPage() {
  ...
  const [metrics, setMetrics] = useState<DashboardMetrics>({
    ...
    activeInstanceName: "WhatsApp Instance",
  ...
  const isInstanceConnected = (metrics.connectedInstancesCount || 0) > 0;
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs font-semibold text-slate-500 dark:text-slate-400">Loading CRM command center telemetry...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200/80 dark:border-slate-800/80 pb-5">
        <div>
          <div className="flex items-center gap-2">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md text-[11px] font-semibold bg-emerald-50 text-emerald-700 dark:bg-emerald-950/50 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800">
              <Activity className="w-3 h-3" /> Live CRM Telemetry
            </span>
          ...
          <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white mt-1">
            CRM & Broadcast Command Center
          </h1>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
            Real-time audience analytics, campaign delivery metrics, and instance telemetry.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          <button
            ...
            disabled={refreshing}
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 text-xs font-semibold shadow-xs transition-colors cursor-pointer disabled:opacity-50"
          >
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-slate-900 hover:bg-slate-800 dark:bg-slate-800 dark:hover:bg-slate-700 text-white text-xs font-semibold shadow-xs transition-colors"
          >
          ...
          <Link
            href="/campaigns/new"
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold shadow-xs shadow-emerald-600/20 transition-colors"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Link href="/contacts" className="block group">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs hover:border-emerald-500/50 transition-all">
            ...
            <div className="mt-2.5">
              ...
              <span className="text-xs text-slate-400 ml-1.5 font-medium">contacts</span>
            </div>
        ...
        {/* KPI 3: Total Campaigns Sent */}
        <Link href="/campaigns" className="block group">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs hover:border-indigo-500/50 transition-all">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                Campaigns Sent
              </span>
            ...
            <div className="mt-2.5">
              ...
              <span className="text-xs text-slate-400 ml-1.5 font-medium">campaigns</span>
            </div>
            <div className="mt-2 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800/80 pt-2">
              <span className="text-indigo-600 dark:text-indigo-400 font-semibold">
                {metrics.sentMessages.toLocaleString()} msgs sent
              </span>
              <span className="text-slate-400">
        ...
        {/* KPI 4: Replies Received */}
        <Link href="/received-messages" className="block group">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs hover:border-sky-500/50 transition-all">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                Replies Received
              </span>
              <div className="w-8 h-8 rounded-lg bg-sky-50 dark:bg-sky-950/60 border border-sky-200 dark:border-sky-800/60 flex items-center justify-center text-sky-600 dark:text-sky-400 group-hover:scale-105 transition-transform">
                <MessageSquare className="w-4 h-4" />
              </div>
            </div>
            <div className="mt-2.5">
              <span className="text-2xl font-black tracking-tight text-sky-600 dark:text-sky-400">
                {metrics.incomingReplies.toLocaleString()}
              </span>
              <span className="text-xs text-slate-400 ml-1.5 font-medium">replies</span>
            </div>
            <div className="mt-2 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800/80 pt-2">
        ...
        {/* KPI 5: Auto-Replies Set */}
        <Link href="/auto-reply" className="block group">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs hover:border-purple-500/50 transition-all">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                Auto-Replies Set
              </span>
            ...
            <div className="mt-2.5">
              <span className="text-2xl font-black tracking-tight text-slate-900 dark:text-white">
                {metrics.autoReplyCount.toLocaleString()}
              </span>
              <span className="text-xs text-slate-400 ml-1.5 font-medium">active rules</span>
            </div>
            <div className="mt-2 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800/80 pt-2">
              <span className="text-purple-600 dark:text-purple-400 font-medium">
                {metrics.autoReplyCount > 0 ? "Automations Active" : "No rules active"}
              </span>
              <span className="text-slate-400">
                Keywords Configured
              </span>
        ...
        {/* KPI 6: Message Templates */}
        <Link href="/templates" className="block group">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs hover:border-amber-500/50 transition-all">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                Templates
              </span>
              <div className="w-8 h-8 rounded-lg bg-amber-50 dark:bg-amber-950/60 border border-amber-200 dark:border-amber-800/60 flex items-center justify-center text-amber-600 dark:text-amber-400 group-hover:scale-105 transition-transform">
                <FileText className="w-4 h-4" />
              </div>
            </div>
            <div className="mt-2.5">
              <span className="text-2xl font-black tracking-tight text-slate-900 dark:text-white">
                {metrics.templatesCount.toLocaleString()}
              </span>
              <span className="text-xs text-slate-400 ml-1.5 font-medium">templates</span>
            </div>
            <div className="mt-2 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800/80 pt-2">
        ...
        <Link href="/report" className="block group">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs hover:border-emerald-500/50 transition-all">
            ...
            <div className="mt-2.5">
              ...
              <span className="text-xs text-slate-400 ml-1.5 font-medium">success rate</span>
            </div>
            <div className="mt-2 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800/80 pt-2">
              <span className="text-emerald-600 dark:text-emerald-400 font-medium">
                {metrics.deliveredMessages.toLocaleString()} delivered
              </span>
              <span className="text-slate-400">
        ...
        <Link href="/report" className="block group">
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-xs hover:border-purple-500/50 transition-all">
            ...
            <div className="mt-2.5">
              ...
              <span className="text-xs text-slate-400 ml-1.5 font-medium">open rate</span>
            </div>
            <div className="mt-2 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800/80 pt-2">
              <span className="text-purple-600 dark:text-purple-400 font-medium">
                {metrics.readMessages.toLocaleString()} blue ticks
              </span>
              <span className="text-slate-400">
                Engagement
              </span>
      ...
      {/* 3. Center Section: Velocity Chart (60%) & Delivery Diagnostics (40%) */}
        ...
        <div className="lg:col-span-7 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-xs flex flex-col justify-between">
                    ...
                    >
                      ...
                      {isHovered && (
                        <rect
                          ...
                          height="180"
                          fill="currentColor"
                          className="text-slate-100/80 dark:text-slate-800/60 rounded"
                          rx="6"
                        />
                      )}
                      ...
                      {(activeChartMetric === "all" || activeChartMetric === "sent") && (
                        <rect
                          ...
                          width="8"
                          height={sentH}
                          className={`fill-indigo-500 transition-all ${isHovered ? "opacity-100" : "opacity-85"}`}
                          rx="3"
                        />
                      )}
                      ...
                      {(activeChartMetric === "all" || activeChartMetric === "delivered") && (
                        <rect
                          ...
                          width="8"
                          height={delH}
                          className={`fill-emerald-500 transition-all ${isHovered ? "opacity-100" : "opacity-85"}`}
                          rx="3"
                        />
                      )}
                      ...
                      {(activeChartMetric === "all" || activeChartMetric === "replies") && (
                        <rect
                          ...
                          width="8"
                          height={repH}
                          className={`fill-purple-500 transition-all ${isHovered ? "opacity-100" : "opacity-85"}`}
                          rx="3"
                        />
                      )}
          ...
          <div className="mt-4 flex flex-wrap items-center justify-between gap-3 text-xs text-slate-500 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800/80 pt-3">
            ...
            <span className="text-[11px] text-slate-400">
              Optimal Response Timing: 10:00 AM – 3:00 PM
            </span>
          </div>
        </div>
        ...
        <div className="lg:col-span-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-xs flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800/80 pb-3">
              ...
              <span className="px-2.5 py-0.5 rounded-md bg-emerald-50 text-emerald-700 dark:bg-emerald-950/60 dark:text-emerald-300 text-xs font-bold border border-emerald-200 dark:border-emerald-800">
            ...
            <div className="mt-5 space-y-4">
              ...
              <div className="space-y-2.5 text-xs">
                ...
                <div className="flex items-center justify-between p-2.5 rounded-lg bg-purple-50/60 dark:bg-purple-950/30 border border-purple-100 dark:border-purple-900/40">
                  <div className="flex items-center gap-2">
                ...
                <div className="flex items-center justify-between p-2.5 rounded-lg bg-emerald-50/60 dark:bg-emerald-950/30 border border-emerald-100 dark:border-emerald-900/40">
                  <div className="flex items-center gap-2">
                ...
                <div className="flex items-center justify-between p-2.5 rounded-lg bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-800">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-slate-600 dark:text-slate-300">Queued / In Transit</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-2.5 rounded-lg bg-rose-50/60 dark:bg-rose-950/30 border border-rose-100 dark:border-rose-900/40">
                  <div className="flex items-center gap-2">
        ...
        <div className="lg:col-span-8 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-xs">
          ...
          {metrics.recentCampaigns && metrics.recentCampaigns.length > 0 ? (
                      ...
                      <tr key={cmp.id} className="hover:bg-slate-50/80 dark:hover:bg-slate-800/40 transition-colors">
                        ...
                        <td className="py-3 text-right">
                          <Link 
                            ...
                            className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 text-[11px] font-semibold transition-colors border border-slate-200 dark:border-slate-700"
                          >
                            <span>Report</span>
            ...
            <div className="py-12 text-center space-y-2">
              ...
              <p className="text-[11px] text-slate-400">Launch your first campaign to see live delivery metrics.</p>
              <div className="pt-2">
                <Link
                  href="/campaigns/new"
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-5 shadow-xs space-y-3">
            ...
            <div className="space-y-2 text-xs font-semibold">
              ...
              <Link 
                href="/contacts" 
                className="flex items-center justify-between p-2.5 rounded-lg bg-slate-50 dark:bg-slate-800/60 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700/80 transition-colors"
              >
                <div className="flex items-center gap-2.5">
                  <Upload className="w-4 h-4 text-indigo-500" />
                  <span>Import Contacts (CSV / Excel)</span>
                </div>
          ...
          <div className="bg-slate-900 text-white rounded-xl p-5 shadow-xs space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[11px] text-slate-400">Anti-Ban Protection</span>
            </div>
            ...
            <div className="pt-2 border-t border-slate-800 flex items-center justify-between text-xs">
              ...
              <div className="flex items-center gap-1.5">
                <span className={`w-2 h-2 rounded-full ${isInstanceConnected ? "bg-emerald-400 animate-pulse" : "bg-amber-400"}`} />
                <span className={`font-bold ${isInstanceConnected ? "text-emerald-400" : "text-amber-400"}`}>
                  {isInstanceConnected ? "Connected" : "Disconnected"}
                </span>
              </div>
            </div>
