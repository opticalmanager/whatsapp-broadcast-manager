    ...
    try {
      ...
      if (rows && rows.length > 0) {
        ...
        return {
          ...
          minDelaySec: Number(r.min_delay_sec) || 15,
          maxDelaySec: Number(r.max_delay_sec) || 20,
          sleepEnabled: r.sleep_enabled !== false,
          sleepAfterMessages: Number(r.sleep_after_messages) || 25,
          sleepForSeconds: Number(r.sleep_for_seconds) || 10,
